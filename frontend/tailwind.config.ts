...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'display-2xl': ['7rem', { lineHeight: '1', letterSpacing: '-0.04em', fontWeight: '600' }],
        'display-xl': ['5.5rem', { lineHeight: '1.02', letterSpacing: '-0.035em' }],
        'display': ['4rem', { lineHeight: '1.08', letterSpacing: '-0.025em' }],
        'heading-1': ['3rem', { lineHeight: '1.12', letterSpacing: '-0.02em' }],
        'heading-2': ['2.25rem', { lineHeight: '1.18', letterSpacing: '-0.015em' }],
        'heading-3': ['1.5rem', { lineHeight: '1.28', letterSpacing: '-0.01em' }],
