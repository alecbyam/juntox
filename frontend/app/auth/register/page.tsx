      ...
      <div className="relative w-full max-w-md px-6 py-16">
        ...
        {success ? (
          <div className="mt-10 rounded-2xl border border-green-500/20 bg-green-500/[0.04] p-6 text-center">
            ...
            <Link
              href="/auth/login"
              className="mt-5 inline-flex items-center justify-center rounded-full bg-primary px-6 py-2.5 text-sm font-semibold text-white transition hover:bg-primary-light"
            >
              Se connecter
            </Link>
          </div>
