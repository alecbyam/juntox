          ...
          <div className="container-content">
            <AnimatedSection>
              ...
              <Link
                ...
                className="group mt-6 block card-gradient-border transition-all duration-300 hover:-translate-y-0.5 hover:shadow-glow"
              >
                <div className="flex flex-wrap items-center gap-3">
                  <Badge>{featured.category ?? 'JuntoX'}</Badge>
                ...
                <div className="mt-6 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-neutral-600">{formatArticleDate(featured.created_at)}</span>
                  </div>
              ...
              <AnimatedSection key={article.slug} delay={i * 0.07}>
                <Link href={`/blog/${article.slug}`} className="card-interactive card-shine group flex h-full flex-col">
                  ...
                  <div className="mt-5 flex items-center justify-between">
                    <time dateTime={article.created_at} className="text-xs text-neutral-600">
