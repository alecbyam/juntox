...
const columns = [
  ...
  {
    title: 'Expertise & Croissance',
    links: [
      { href: '/consultance', label: 'Consultance & Études' },
      { href: '/formation', label: 'Formation' },
      { href: '/investissements', label: 'Investissement & Incubation' },
      { href: '/secteurs-emergents', label: 'Secteurs Émergents' },
